...
<Update label="2026-05-21" tags={["Update"]} description="v5.4.1">
  ## v5.4.1 — Higher data refresh rates and decoupled aim assist

  This update improves how frequently game data is read and separates aim assist timing from the main update loop. Expect snappier aim tracking, more responsive overlays, and smoother overall performance.
