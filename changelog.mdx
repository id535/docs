...
<Update label="2026-05-19" tags={["Feature","Update"]} description="v5.4.0">
  ...
  - **Bomb radar icons** — Added C4 inditators to the radar. Planted, dropped bomb as well as bomb carrier.
  ...
  - **ESP overhaul for stability** — Temporarily removed the previous TraceShape visibility system (which causes instability).
