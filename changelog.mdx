...
<Update label="2026-05-29" tags={["Update"]} description="v5.4.2">
  ...
  - Restored stable bone projection & skeleton rendering in ESP (fixed disappearing/over-sized skeletons and boxes by using a stable bone reader with fallback paths)
</Update>
