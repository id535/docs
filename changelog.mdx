...
<Update label="2026-05-19" tags={["Feature","Update"]} description="v5.4.0">
  ## v5.4.0 — Radar polish, new sounds & refined aim assist

  This update brings a cleaner radar experience, an expanded library of custom hit and kill sounds with instant previews, and a more reliable, modernized aim assist system.

  ### New features

  - **Custom hit & kill sounds** — Browse and instantly preview from a large new collection of satisfying sounds directly in the menu.
  - **Unified bomb radar icons** — Planted, dropped, and carrier bombs now use consistent, easy-to-read icons with a clean black border.

  ### Updates

  - **Smarter bomb timer & radar** — Ghost dropped bombs no longer linger. Added more precise bomb timing data and reorganized toggles for clarity.
  - **Modern aim assist** — Switched to reliable hold-based aiming with target stickiness, health-based priority, and velocity prediction. Smoothing now adapts dynamically to your aim speed.
  - **Sharper ESP** — Visibility checks are more consistent, ESP feels snappier, and head circle sizing is stable. Teammate colors now strictly match in-game spotted status.
  - **Better UI scaling** — Full per-monitor DPI awareness keeps menus and overlays crisp on any Windows display scale.
  - **Sounds category** — New dedicated section in Extras for managing hit and kill sounds.

  ### Bug fixes

  - Numerous stability and responsiveness improvements from extensive cleanup and refactoring.
